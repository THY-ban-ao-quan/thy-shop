...
<table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
    ...
    <form action="?mod=taikhoan&act=addCSDL" method="POST" role="form" enctype="multipart/form-data">
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="" placeholder="" name="tenND" required >
            
        </div>
        <div class="form-group">
            <label for="">Số Điện Thoại</label>
            <input type="text" class="form-control" id="" placeholder="" name="SDT" required pattern="[0-9]+" minlength="10">
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="" placeholder="" name="diaChi" required>
        </div>
        <div class="form-group">
            <label for="">Mật Khẩu</label>
            <input type="Password" class="form-control" id="" placeholder="" name="matKhau" required minlength="6">
        </div>                
        <div class="form-group">
